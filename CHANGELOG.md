...
- **docs:** Update test/code-style badges to point to `3.x` branch
- **docs:** Update screenshot URL to `3.x` branch
...
**Full Changelog**: https://github.com/joaopaulolndev/filament-general-settings/compare/v3.0.4...v3.0.5

## v3.0.4 - 2026-05-10

### What's Changed

- **feat:** Add back `RichEditor` support to custom field types by @Ali13Yassin in #43
- **feat:** Add Kurdish Sorani (`ckb`) language translations by @Hamoi1 in #42

### New Contributors

- @Ali13Yassin made their first contribution in #43
- @Hamoi1 made their first contribution in #42

**Full Changelog**: https://github.com/joaopaulolndev/filament-general-settings/compare/v3.0.3...v3.0.4
...
**Full Changelog**: https://github.com/joaopaulolndev/filament-general-settings/compare/v3.0.2...v3.0.3
...
- Fix `routes()` method signature to be compatible with Filament's `PageConfiguration` parameter
